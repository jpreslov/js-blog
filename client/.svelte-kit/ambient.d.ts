...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies_uploadthing: string;
	...
	export const npm_package_dependencies__uploadthing_svelte: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies_uploadthing: string;
		...
		npm_package_dependencies__uploadthing_svelte: string;
